...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - CO2 - 1 BAR - ETR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.29485569751494
exported_pipeline = make_pipeline(
    make_union(
        FunctionTransformer(copy),
        FunctionTransformer(copy)
    ),
    ExtraTreesRegressor(bootstrap=False, max_depth=17, min_samples_leaf=1, min_samples_split=2, n_estimators=300)
)
