...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - CH4 - 10 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.30505223808539716
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.7500000000000001, min_samples_leaf=1, min_samples_split=2, n_estimators=100)
