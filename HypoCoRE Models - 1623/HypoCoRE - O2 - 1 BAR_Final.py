...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE - HighHenry/HypoCoRE - O2 - 1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0007017296775998908
exported_pipeline = make_pipeline(
    RobustScaler(),
    StackingEstimator(estimator=RidgeCV()),
    RandomForestRegressor(bootstrap=False, max_features=0.4, min_samples_leaf=1, min_samples_split=5, n_estimators=100)
)
