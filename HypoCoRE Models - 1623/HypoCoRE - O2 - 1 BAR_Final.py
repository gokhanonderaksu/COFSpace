...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - O2 - 1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.000696472603095157
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    ExtraTreesRegressor(bootstrap=False, max_features=0.6500000000000001, min_samples_leaf=1, min_samples_split=8, n_estimators=100)
)
