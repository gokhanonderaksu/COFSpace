...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - CO2 - 10 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -2.0910001508400198
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=10, min_child_weight=5, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.45, verbosity=0)
