...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE - HighHenry/HypoCoRE - CO2 - 10 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -2.1448237984127774
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=9, min_child_weight=14, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.6000000000000001, verbosity=0)
