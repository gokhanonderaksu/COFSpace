...
from sklearn.ensemble import ExtraTreesRegressor  # ExtraTreesRegressor'ı import ediyoruz
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - CO2 - 5 BAR - ETR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -1.046540055118633
exported_pipeline = make_pipeline(
    ...
    ExtraTreesRegressor(bootstrap=False, max_depth=11, min_samples_leaf=1, min_samples_split=2, n_estimators=200)
)
...
X_unseen = pd.read_csv('C:/Users/Lenovo/Desktop/KodSystems/TPOT/Unseen/Unseen - CO2 -  Henrys - ALL.csv', sep=',')
