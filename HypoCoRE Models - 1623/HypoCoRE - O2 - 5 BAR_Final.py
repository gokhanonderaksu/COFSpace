...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - O2 - 5 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.023410743894850036
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.6500000000000001, min_samples_leaf=1, min_samples_split=5, n_estimators=100)
...
X_unseen = pd.read_csv('C:/Users/Lenovo/Desktop/KodSystems/TPOT/Unseen/Unseen - O2 -  Henrys - ALL.csv', sep=',')
