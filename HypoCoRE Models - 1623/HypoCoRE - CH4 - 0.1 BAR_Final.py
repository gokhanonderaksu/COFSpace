...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - CH4 - 0.1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.00020034474058020632
exported_pipeline = make_pipeline(
    ZeroCount(),
    StackingEstimator(estimator=RidgeCV()),
    XGBRegressor(learning_rate=0.1, max_depth=7, min_child_weight=4, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.55, verbosity=0)
)
...
X_unseen = pd.read_csv('C:/Users/Lenovo/Desktop/KodSystems/TPOT/Unseen/Unseen - CH4 -  Henrys - ALL.csv', sep=',')
