...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - CH4 - 1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.030001909528509434
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=7, min_child_weight=4, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.6000000000000001, verbosity=0)
