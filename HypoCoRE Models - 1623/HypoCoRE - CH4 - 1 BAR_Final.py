...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE - HighHenry/HypoCoRE - CH4 - 1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.023011967720292174
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.9000000000000001, min_samples_leaf=1, min_samples_split=3, n_estimators=100)
