...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/HypoCoRE/HypoCoRE - O2 - 0.1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -8.271167297129454e-07
exported_pipeline = make_pipeline(
    StandardScaler(),
    StackingEstimator(estimator=DecisionTreeRegressor(max_depth=10, min_samples_leaf=14, min_samples_split=12)),
    RidgeCV()
)
