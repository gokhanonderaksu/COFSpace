...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF - HighHenry/CoRECOF - N2 - 10 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.021737086388766747
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    ExtraTreesRegressor(bootstrap=False, max_features=0.6500000000000001, min_samples_leaf=1, min_samples_split=2, n_estimators=100)
)
