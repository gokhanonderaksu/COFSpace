...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF/CoRECOF - O2 - 1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0001501386038614948
exported_pipeline = make_pipeline(
    ZeroCount(),
    XGBRegressor(learning_rate=0.1, max_depth=3, min_child_weight=3, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.9000000000000001, verbosity=0)
)
