...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF - HighHenry/CoRECOF - CO2 - 0.1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0017023641892221074
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.7500000000000001, min_samples_leaf=1, min_samples_split=4, n_estimators=100)
