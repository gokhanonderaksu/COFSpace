...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF - HighHenry/CoRECOF - CO2 - 1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.1167287795802296
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=3, min_child_weight=7, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.4, verbosity=0)
