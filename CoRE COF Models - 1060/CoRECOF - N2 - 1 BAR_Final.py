...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF/CoRECOF - N2 - 1 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.00011255884355266808
exported_pipeline = make_pipeline(
    StandardScaler(),
    LinearSVR(C=25.0, dual=True, epsilon=0.0001, loss="squared_epsilon_insensitive", tol=1e-05)
)
