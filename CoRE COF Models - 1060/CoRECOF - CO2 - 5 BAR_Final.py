...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF/CoRECOF - CO2 - 5 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.8445096688859188
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=3, min_child_weight=6, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.7000000000000001, verbosity=0)
...
X_unseen = pd.read_csv('C:/Users/Lenovo/Desktop/KodSystems/TPOT/Unseen/Unseen - CO2 -  Henrys - 11467.csv', sep=',')
