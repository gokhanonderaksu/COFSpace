...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF - HighHenry/CoRECOF - CH4 - 5 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.06507817459679846
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=4, min_child_weight=5, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.8500000000000001, verbosity=0)
