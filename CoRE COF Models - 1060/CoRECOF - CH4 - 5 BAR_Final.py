...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF/CoRECOF - CH4 - 5 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.06502259081931763
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=4, min_child_weight=4, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.8, verbosity=0)
...
X_unseen = pd.read_csv('C:/Users/Lenovo/Desktop/KodSystems/TPOT/Unseen/Unseen - CH4 -  Henrys - 11467.csv', sep=',')
