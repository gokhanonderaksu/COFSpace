...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF/CoRECOF - O2 - 5 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.008309944227529828
exported_pipeline = make_pipeline(
    StandardScaler(),
    XGBRegressor(learning_rate=0.1, max_depth=3, min_child_weight=4, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.8, verbosity=0)
)
...
X_unseen = pd.read_csv('C:/Users/Lenovo/Desktop/KodSystems/TPOT/Unseen/Unseen - O2 -  Henrys - 11467.csv', sep=',')
