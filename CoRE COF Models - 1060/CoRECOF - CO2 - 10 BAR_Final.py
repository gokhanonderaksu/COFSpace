...
tpot_data = pd.read_csv('C:/ERC Project - COF Storage/ML Excels/OnlyCoRECOF/CoRECOF - CO2 - 10 BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -1.6875993031204501
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=8, min_child_weight=4, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.45, verbosity=0)
